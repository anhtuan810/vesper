export function Hero() {
  return (
    <div className="max-w-[1200px] mx-auto" style={{ padding: "0 var(--wrap-pad)" }}>
      <section style={{ padding: "clamp(24px,4vw,48px) 0 clamp(28px,4vw,56px)" }}>
        <div
        ...
        >
          ...
          <div>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <span className="font-serif italic text-faint" style={{ fontSize: 13 }}>
          ...
          <div className="w-full max-w-[580px] ml-auto max-[920px]:mx-auto max-[920px]:pt-4">
            <div className="grid min-[920px]:grid-cols-[1.35fr_1fr] gap-3 max-[920px]:gap-[14px]">
              ...
              <div
                ...
                style={{ padding: "clamp(18px,3vw,22px)", boxShadow: "0 1px 2px rgba(26,31,46,0.03), 0 32px 64px -28px rgba(26,31,46,0.18)" }}
              >
                <div className="text-faint uppercase tracking-[0.08em] mb-1" style={{ fontSize: "10.5px" }}>Net worth</div>
                <div
