    ...
    <div className="max-w-[1200px] mx-auto" style={{ padding: "0 var(--wrap-pad)" }}>
      ...
      >
        ...
        <div className="grid gap-[18px] items-stretch min-[820px]:grid-cols-[1fr_1.1fr] min-[820px]:gap-0">
          ...
          {/* Decision card */}
          <div
            className="bg-surface border border-border rounded-2xl min-[820px]:rounded-r-none min-[820px]:border-r-0"
          ...
          >
            ...
            <div
              className="uppercase tracking-[0.1em] font-medium mb-2"
            ...
            >
              {/* Opening quote via inline span matches mockup ::before */}
              <span
                className="font-serif"
                style={{ fontSize: 26, color: "var(--text-faint)", verticalAlign: "-8px", marginRight: 2, lineHeight: 0 }}
              >
                &ldquo;
              </span>
          ...
          {/* Context card */}
          <div
            className="rounded-2xl min-[820px]:rounded-l-none flex flex-col"
            style={{
          ...
          >
            ...
            <div className="flex items-center gap-3 pb-[14px] mb-[14px] border-b border-border">
              ...
              <div>
                <div
                  ...
                  style={{ fontSize: 16, fontVariationSettings: "'opsz' 17" }}
                >
                  What was happening then
                </div>
                <div
                  className="uppercase tracking-[0.06em] mt-[2px]"
                  style={{ fontSize: "10.5px", color: "var(--text-faint)" }}
                >
            ...
            <div className="flex flex-col">
              {[
                ...
                >
                  <span
                    className="uppercase tracking-[0.08em] font-medium flex-shrink-0"
                    style={{ fontSize: "10.5px", color: "var(--text-faint)" }}
                  >
                    {row.k}
                  </span>
                  <span
                    className="font-serif font-medium text-right text-fg leading-[1.35]"
                    style={{ fontSize: 13, fontVariationSettings: "'opsz' 14" }}
                  >
                    {row.v}
                  </span>
                </div>
            ...
            {/* Footer insight */}
            <div
              className="mt-[14px] pt-3 border-t border-border font-serif text-fg leading-[1.5]"
              style={{ fontSize: "13.5px", fontVariationSettings: "'opsz' 14" }}
            >
              Looking back:{" "}
