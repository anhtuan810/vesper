...
function PortfolioIcon({ active }: { active: boolean }) {
  if (active) {
    return (
      <svg viewBox="0 0 256 256" fill="currentColor" className="w-[26px] h-[26px]">
  ...
  return (
    <svg viewBox="0 0 256 256" fill="none" stroke="currentColor" strokeWidth="14" strokeLinecap="round" strokeLinejoin="round" className="w-[26px] h-[26px]">
