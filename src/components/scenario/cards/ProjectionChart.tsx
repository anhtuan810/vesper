  ...
  return (
    <div style={{ display: "flex", alignItems: "stretch", height: H }}>
      <div ref={ref} style={{ flex: 1, position: "relative" }}>
        ...
        <span style={{ position: "absolute", bottom: 0, left: `${(xT / Math.max(w, 1)) * 100}%`, transform: "translateX(-50%)", fontSize: "var(--fs-micro)", color: "var(--text-faint)" }}>today</span>
        <span style={{ position: "absolute", bottom: 0, right: 0, fontSize: "var(--fs-micro)", color: "var(--text-faint)", fontFamily: "var(--font-numeric)" }}>{horizonYear}</span>
      </div>
