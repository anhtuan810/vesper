...
- ~~**No tests**. Zero unit, integration, or E2E coverage.~~ — **shipped**: per-commit hermetic suite (`npm test`) + nightly model and demo behaviour evals. See "Automated Testing & Chat Behaviour Evals" above.
